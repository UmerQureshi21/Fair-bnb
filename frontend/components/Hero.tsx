      ...
      <div className="flex flex-col justify-center">
        <FadeIn trigger="mount">
          <span className="ml-[5px] mb-[-20px] flex w-fit items-center text-sm font-bold  tracking-wide text-muted">
            Built with
            <img
              src="stay22-logo.webp"
              alt="Stay22"
              className="h-20 w-auto ml-[-15px]"
            />
          </span>
        </FadeIn>
        <FadeIn trigger="mount" delay={100}>
        ...
        <FadeIn trigger="mount" delay={200}>
          <p className="mt-5 max-w-md text-lg text-muted">
            Upload a video of any listing. Fairbnb uses vector embeddings to match
            it against <span className="text-brand">identical </span> looking
            hotels and tell you what it&apos;s actually worth
          </p>
        </FadeIn>
      </div>

      <div className="relative flex min-h-64 items-center justify-center top-[100px] right-[100px]">
